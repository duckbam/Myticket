...
<c:if test="${not empty msg}"><script>alert("${msg}")</script></c:if>
	<div id="wrapper">
		<div id="page-content-wrapper">
				<h2><b>${searchDto.category} 문의</b></h2><br>
				<form name="form" id="form" role="form" method="post">
					...
					<div class="mb-3">
						...
						<select name="saleCode" class="form-select">
							<option value="선택하지 않음" selected="selected">선택하지 않음</option>	
					...
					<div class="d-grid gap-2 d-md-flex justify-content-md-end">
						<button type="submit" class="btn btn-sm btn-primary" id="btnSave" formaction="${root }centerWriteProc?reUri=${reUri}">저장</button>
